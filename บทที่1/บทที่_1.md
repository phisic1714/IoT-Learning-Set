...
* ทำงานโดยการสลับสถานะ LED ระหว่าง LED_LOW และ LED_HIGH ทุกๆ 1 วินาที จากนั้นจะทำงานวนลูปไปเรื่อยๆ ของ LED_BUILTIN
...
* ทำงานโดยการสลับสถานะ LED ระหว่าง LED_LOW และ LED_HIGH ทุกๆ 1 วินาที จากนั้นทำงานวนลูปไปเรื่อยๆ ของ LED ภายนอก
...
* จากโค้ดตัวอย่างจะเห็นได้ว่ามีการสั่งให้แต่ล่ะ Segment ทำงานเหมือนกับการสั่ง LED ทำงาน โดยใช้ฟังก์ชั่น digitalWrite() แต่ล่ะ Segment ซึ่งทำให้เกิดมีการใช้คำสั่งซ้ำๆ จึงมีวิธีเพิ่มเติมในการกำหนดการทำงานแต่ล่ะ Segment ให้ดูสั้นลง โดยจะแทนตำแหน่ง Segment ให้อยู่ในเลขฐาน 16 
...
* จากโค้ด มีการทำงานคือ แสดงผลบน 7 Segment Display โดยมีการเปลี่ยนการแสดงผลทีละ Segment ในแต่ละสถานะ ทุกๆ 0.5 วินาทีจะเปลี่ยน Segment โดยมีลำดับดังนี้ คือ A, B, G_ROUND1, E, D, C, G_ROUND2, F แล้วกลับมาแสดงที่ A อีกครั้ง
